...
import { CloseOutline, ExternalLinkOutline, GithubOutline } from "@styled-icons/evaicons-outline";
    ...
    >
      <div className="flex flex-col">
        <div
          ...
          style={{
            backgroundImage: "radial-gradient(circle, rgba(70,70,70,1) 0%, rgba(0,0,0,1) 100%)",
          }}
        >
          {props.title}
        </div>
        ...
        <div className="p-4 overflow-auto scroll" style={{ height: "80vh" }}>
          ...
          <div className="flex flex-row w-full justify-evenly">
            {props.githubLink !== "N/A" ? (
              <div className="text-left text-md">
                <button className="px-8 py-4 rounded bg-black hover:bg-purple-600 cursor-pointer shadow hover:shadow-2xl text-white">
                  <a href={props.githubLink} target="_blank" className="orbitron-font">
                    Source code
                  </a>
            ...
            {props.liveLink !== "N/A" ? (
              <div className="text-left text-md">
                <button className="px-8 py-4 rounded bg-black hover:bg-purple-600 cursor-pointer shadow hover:shadow-2xl text-white">
                  <a href={props.liveLink} target="_blank" className="orbitron-font">
                    View Live
                  </a>
          ...
          {props.stack !== undefined ? (
            <div>
              <h1 className="orbitron-font font-bold text-center">Tech Stack</h1>
